  ...
  return (
    <C.WebModal show={show} onClose={onClose} size="large">
      <div className="web-send-card">
        ...
        <input type="text" className="web-send-card-input" onChange={handleInput} placeholder='Please enter wallet address' />
        <C.WebButton disabled={!isCanSend} type='blue' onClick={handleSend}>Send</C.WebButton>
      </div>
