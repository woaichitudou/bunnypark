...
const BlindBoxBuy: FC = () => {
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      history.push(`/bunny/buy/succeed/${boxId}/${param}`)
    } catch (e) {
      setStatus('Failure')
    }
  }
  ...
  return (
    <div className='web-rabbit-buy'>
      <C.WebTitle title='You Will Be Getting' />
      ...
      <div className='web-rabbit-buy-balance'>Wallet Balance:  <span>{balance} bp</span></div>
      <div className='web-rabbit-buy-btn'><C.WebButton onClick={handleBuy} disabled={!canBuy}>Pay Now</C.WebButton></div>
