...
const ChooseCity: FC = () => {
  ...
  return (
    <div className='web-choose-city'>
      <C.WebTitle title='Destination' />
      <p>Start your adventure to {ventureCity?.cityName}</p>
      {
        !isEmpty(ventureCity) &&
        (<div className="web-choose-city-content"><C.WebCityCard
          btnName='Confirm'
          disabled={isDisabled}
      ...
      <Result
        ...
        cityName={ventureCity?.cityName ?? '-'}
        callback={() => history.push('/adventure/cities')}
        onClose={() => setModalStatus('')} />
      <C.WebPayTicketsModal
