    ...
    <>{
      innerVisible && <TouchScrollable>
        <div className='m-result'>
          <div className="m-result-box" onClick={handleClick} />
          {succeed ? <div className="m-result-succeed">
            <h2>Success</h2>
            ...
            <C.Button onClick={handleGoBackEv}>Check</C.Button>
            {/* <div className="m-result-succeed-btn-blue"> */}
            {/*  <C.Button type='blue' onClick={handleGoBackEv}>Close</C.Button> */}
            {/* </div> */}
          </div> : <div className="m-result-fail">
            <h2>Failed</h2>
            <C.WebImage src='adventure/fail.png' />
            <p>Your adventure to {cityName}  has failed. You will not get any rewards.</p>
            <div className="m-result-fail-btn-fail" onClick={handleGoBackEv}>Confirm</div>
          </div>}
        </div>
      </TouchScrollable>
    }
