...
export const Components: FC<Porps> = ({ disabled = false, cityName, power, ticket, successRate, earnings, onClick, btnName = 'Adventure' }) => {
  ...
  return (
    <div className='m-city-card'>
      <div className="m-city-card-title">{cityName}</div>
      <div className="m-city-card-box">
        <div className="m-city-card-box-min">
          ...
          <ul>
            <li>
              ...
              <div className="m-progress-bar">
                {power.weight === 0 ? null : <div className="m-progress-bar-above" style={{ width: power.weight }}></div>}
                <div className="m-progress-bar-following"></div>
              </div>
            </li>
            <li>
              ...
              <div className="m-progress-bar">
                {ticket.weight === 0 ? null : <div className="m-progress-bar-above" style={{ width: ticket.weight }}></div>}
                <div className="m-progress-bar-following"></div>
              </div>
            </li>
            <li>
              ...
              <div className="m-progress-bar">
                {successRate.weight === 0 ? null : <div className="m-progress-bar-above" style={{ width: successRate.weight }}></div>}
                <div className="m-progress-bar-following"></div>
              </div>
            </li>
            <li>
              ...
              <div className="m-progress-bar">
                {earnings.weight === 0 ? null : <div className="m-progress-bar-above" style={{ width: earnings.weight }}></div>}
                <div className="m-progress-bar-following"></div>
              </div>
            </li>
          </ul>
          <C.Button type='yellow' disabled={disabled} onClick={onClick}>{btnName}</C.Button>
        </div>
      </div>
    </div>
