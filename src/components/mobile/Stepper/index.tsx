...
const Components: FC<Props> = ({ size = 'default', value = 0, min = 0, max = 10, step = 1, onChange, cRef }) => {
  // 组件内维护的数据
  ...
  return (
    <div className={classNames('m-stepper', `m-stepper-size-${size}`)} >
      <button
        className="m-stepper-sub"
